...
<html lang="en">
	...
	<body>
		...
		<section id="featured">
			...
			{
				echo "<a href=contact.php>Contact us to become a registered fan</a>";
			}else if (isset($_SESSION['role']) && ($_SESSION['role']=='player' || $_SESSION['role']=='admin')){
				$con=mysqli_connect('localhost','root','','Leicester');
				$query = mysqli_query($con,"SELECT * FROM fan,user WHERE fan.username=user.username ORDER BY time");
				...
				while($row= mysqli_fetch_assoc($query))
				{
					...
					echo "<li class='list-group-item'><strong>".$row['username']."</strong>     cardnumber:      <strong>".$row['cardnum']."</strong></li><label>Bio:".$row['bio']."</label>";
