		...
		<div id="wrapper">
			...
			<section id="content">
				<?php
					...
					$query = mysqli_query($con,"SELECT * FROM player");
				...
				<div class="container">
					<div class="row">
						<div class="span6">
							<h6 class="text-muted">List Group of players</h6> 
							<div class="list-group">
								<?php
									while($row = mysqli_fetch_assoc($query)){									
										echo "<label class='list-group-item  list-group-item-action'>".$row['username']."</label>";
										echo "<div class='image-parent'>";
										$query2=mysqli_query($con,"SELECT filename FROM photos WHERE id=(SELECT MIN(id) FROM photos WHERE username='".$row['username']."')");
										$row2=mysqli_fetch_assoc($query2);
										if($row2!=null){
										echo  "<img src='".$row2['filename']."'class='img-fluid' alt='".$row['username']."' width='200' height='200' border='0' class='img-circle'>";
										echo "<a href='players.php?player=".$row['username']."'>Show posts</a>";
									}
									else
									    echo "<h3>No photos</h3>";
										echo  "</div>";	
						...
						<h6 class="text-muted">Photos</h6> 
							<?php if(isset($_GET['player'])){
							     echo "<label class='list-group-item  list-group-item-action'>Posts from:".$_GET['player']."</label>";
								$query=mysqli_query($con,"SELECT * FROM photos WHERE username='".$_GET['player']."'");
								...
								echo "<img src='".$filename."' class='img-fluid' width='200' height='S00' border='0'>";
